<?php
$config = [
    'access_token' => '28c39d7e39d17cec1473be75004e76c163e21e2e6e0d158266c1213d3514930f2716b2b7654d2094bd7bf',	// Токен от vk admin ( получить тут https://vkhost.github.io/ )
    'reconnect' => true,	// Переподключение: true/on - false/off
    'smartbuy' => true,		// Умный магазин: true/on - false/off (если включен перевод коинов на id тот что ниже то ставить false)
